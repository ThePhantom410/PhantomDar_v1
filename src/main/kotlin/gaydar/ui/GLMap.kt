...
class GLMap(private val jsettings : Settings.jsonsettings) : InputAdapter(), ApplicationListener, GameListener {
  ...
  fun show() {
    ...
    config.setTitle("[${localAddr.hostAddress} ${sniffOption.name}] - PhantomDar v1.0")
  ...
  override fun render() {
    ...
    paint(fontCamera.combined) {
      ...
      if (drawmenu == 1) {
        ...
        // Filters
        if (filterWeapon != 1)
          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + 103f)
        else
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + 103f)
        ...
        if (filterLvl2 == 0)
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + 85f)

        if (filterHeals != 1)
          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + 67f)
        else
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + 67f)

        if (filterThrow != 1)
          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + 49f)
        else
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + 49f)

        if (filterAttach != 1)
          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + 31f)
        else
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + 31f)

        if (filterScope != 1)
          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + 13f)
        else
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + 13f)

        if (filterAmmo != 1)
          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + -5f)
        else
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + -5f)
        ...
        if (nameToggles >= 1)
          ...
          menuFontOn.draw(spriteBatch, "Aktiviert: $togs", 187f, windowHeight / 2 + -89f)
        else
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + -89f)


        // Compass
        if (drawcompass != 1)

          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + -107f)
        else
          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + -107f)


        if (drawDaMap == 1)

          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + -125f)
        else
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + -125f)

        if (toggleView == 1)
          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + -143f)
        else
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + -143f)

        if (VehicleInfoToggles < 3)
          menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + -161f)
        if (VehicleInfoToggles == 3)
          menuFontOFF.draw(spriteBatch, "Deaktiviert", 187f, windowHeight / 2 + -161f)

        // DrawMenu == 1 already
        menuFontOn.draw(spriteBatch, "Aktiviert", 187f, windowHeight / 2 + -179f)
      }
      // DrawMenu == 0 (Deaktiviert)
  ...
  private fun SpriteBatch.drawItem() {
    ...
    sorted.forEach {
      ...
      if (jsettings.Level2Armor && "Item_Armor_D_01_Lv2_C" in items ||
        ...
        // If The Setting is true (boolean) and Item_ is in Items, Don't draw Deaktiviert item.
      }
